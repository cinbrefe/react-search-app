...
A movie search and discovery app where you can explore popular films, search by title, and filter results by genre, rating, and year. Built with React and powered by the TMDB API.
